        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-full max-w-6xl">
          <div className="flex justify-center items-center">
            <div className="w-4/5 bg-white shadow-md h-14 rounded-full flex justify-center text-xs">
              ...
              <div className="w-1/4 flex flex-col text-left items-start space-y-1 px-6 rounded-full">
                <FormField
                  control={form.control}
                  name="date"
                  render={({ field }) => (
              ...
              {/* <div className="w-1/4 flex justify-center items-center bg-orange-500 flex-col text-left px-6 rounded-full"> */}
                <Button type="submit" className="text-white w-1/4 h-full flex justify-center items-center bg-orange-500 flex-col text-left rounded-full">
                  Submit
                </Button>
              {/* </div> */}
            </div>
